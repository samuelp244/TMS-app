        ...
        <div>
          <div className="w-full h-20 items-center flex flex-row justify-between bg-gray-300">
            ...
            <h4 className="flex gap-5">
              {!editProfile && <CgProfile onClick={startEdit} className="text-3xl cursor-pointer"/>}{" "}
          ...
          <div className="">
            <h1 className="m-2 text-center text-3xl text-slate-500"> DashBoard</h1>
          ...
          <div className="m-3 w-auto rounded-md p-5 bg-slate-600 flex flex-">
            <h3>Companies:</h3>
